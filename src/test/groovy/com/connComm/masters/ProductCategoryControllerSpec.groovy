...
class ProductCategoryControllerSpec extends Specification {
    ...
    void "Test the save action correctly persists an instance"() {
        ...
        when:"The save action is executed with a valid instance"
            ...
            productCategory = new ProductCategory(params)
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            ...
            controller.show(productCategory)
    ...
    void "Test that the edit action returns the correct model"() {
        ...
        when:"A domain instance is passed to the edit action"
            populateValidParams(params)
            def productCategory = new ProductCategory(params)
            controller.edit(productCategory)
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        when:"A valid domain instance is passed to the update action"
            response.reset()
            populateValidParams(params)
            productCategory = new ProductCategory(params).save(flush: true)
            controller.update(productCategory)

        then:"A redirect is issued to the show action"
            productCategory != null
            response.redirectedUrl == "/productCategory/show/$productCategory.id"
            flash.message != null
    }
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"A domain instance is created"
            response.reset()
            populateValidParams(params)
            def productCategory = new ProductCategory(params).save(flush: true)

        then:"It exists"
            ProductCategory.count() == 1

        when:"The domain instance is passed to the delete action"
            controller.delete(productCategory)
