...
<html>
    ...
    <body>
        <a href="#create-relationshipType" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-relationshipType" class="content scaffold-create" role="main">
