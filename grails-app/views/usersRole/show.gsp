...
<html>
    ...
    <body>
        ...
        <div id="show-usersRole" class="content scaffold-show" role="main">
            ...
            <f:display bean="usersRole" />
            <g:form resource="${this.usersRole}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.usersRole}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
