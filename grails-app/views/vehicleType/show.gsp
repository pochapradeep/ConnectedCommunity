...
<html>
    ...
    <body>
        ...
        <div id="show-vehicleType" class="content scaffold-show" role="main">
            ...
            <f:display bean="vehicleType" />
            <g:form resource="${this.vehicleType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vehicleType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
